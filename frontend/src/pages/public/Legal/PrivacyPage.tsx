...
export default function PrivacyPage() {
  return (
    <div style={{ maxWidth: 800, margin: "0 auto", padding: "40px 20px", color: "#374151", lineHeight: 1.8 }}>
      ...
      <h2 style={{ fontSize: 18, fontWeight: 600, marginTop: 32, marginBottom: 16, color: "#111827" }}>1. 収集する個人情報</h2>
      ...
      <h2 style={{ fontSize: 18, fontWeight: 600, marginTop: 32, marginBottom: 16, color: "#111827" }}>2. 利用目的</h2>
      <p style={{ marginBottom: 16 }}>
      ...
      <h2 style={{ fontSize: 18, fontWeight: 600, marginTop: 32, marginBottom: 16, color: "#111827" }}>3. 個人情報の第三者提供</h2>
      <p style={{ marginBottom: 16 }}>
        本サービスは、ユーザーの同意を得ることなく、第三者に個人情報を提供することはありません。ただし、法令に基づく場合を除きます。なお、予約が確定した場合、取引に必要な最小限の情報（予約ID等）が対象の農家に共有されます。
      </p>

      <h2 style={{ fontSize: 18, fontWeight: 600, marginTop: 32, marginBottom: 16, color: "#111827" }}>4. 退会時のデータの取り扱い（匿名化）</h2>
      <p style={{ marginBottom: 16 }}>

...
export default function FarmerMenu() {
  ...
  return (
    <div style={{ padding: "24px 16px 120px", maxWidth: 640, margin: "0 auto" }}>
      ...
      {/* フローティングボタン (Floating Action Button) */}
      <button
        ...
        <div style={{ position: "fixed", inset: 0, backgroundColor: "rgba(0,0,0,0.5)", display: "flex", alignItems: "center", justifyContent: "center", zIndex: 2000 }}>
          <div style={{ backgroundColor: "#FFFFFF", borderRadius: 16, padding: 24, width: "90%", maxWidth: 440 }}>
            ...
            <div style={{ fontSize: 14, color: "#374151", lineHeight: 1.6, marginBottom: 20 }}>
              <span style={{ fontWeight: 600, color: "#111827", display: "block", marginBottom: 12 }}>※今後の予約が残っている場合は退会できません。</span>
            ...
            {deleteError && (
              <div style={{ backgroundColor: "#F3F4F6", color: "#111827", padding: "10px", borderRadius: "8px", fontSize: 13, marginBottom: 20, border: "1px solid #D1D5DB" }}>{deleteError}</div>
            )}
            <div style={{ display: "flex", gap: 12 }}>
